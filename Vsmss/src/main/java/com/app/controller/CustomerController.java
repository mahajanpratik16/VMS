...
public class CustomerController {
	...
	@RequestMapping("/previousrecord")
	public ResponseEntity<?> previousRecord(@RequestParam ("email") GetEmailDto dto) {
//	public ResponseEntity<?> previousRecord(@RequestParam GetEmailDto dto) {
		System.out.println(dto.getEmail());
		// service.getPreviousRecord(dto.getEmail());
		System.out.println(service.getPreviousRecord(dto.getEmail()));
